...
public class SearchServiceImpl implements SearchService {
    ...
    public ApiResponse search(SearchFilter filter) {
        ...
        List<Lemma> existLemmas =
            site == null ?
                lemmaRepository.findByLemmaOrderByFrequency(sourceLemmas.keySet().toString()) :
    ...
    @Override
    public Site searchSite(String url) {
        Site site = null;
    ...
    @Override
    public List<Page> searchPages(List<Lemma> existLemmas) {
    ...
    @Override
    public List<SearchResult> computeRelevance(List<Page> pages,
                                                List<Lemma> existLemmas,
